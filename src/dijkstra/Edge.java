...
public class Edge {
	...
	public boolean equals(Object o) {
		if (o instanceof Edge) {
			return ((this.vertex1.equals(((Edge) o).vertex1) && this.vertex2
					.equals(((Edge) o).vertex2)) || (this.vertex1
					.equals(((Edge) o).vertex2) && this.vertex2
	...
	public double getDistance(int currTime, Week day) {
		...
		// if(!isSameStop){
//		System.out
//				.println("normal edge " + timetable.getLineNumber() + " same:"
//						+ (timetable.getFirstTimeAfter(currTime, day)
//								- currTime + distance) + " currTime: "
//						+ currTime);
		// return distance;
		// }
