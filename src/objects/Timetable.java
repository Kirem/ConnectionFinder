...
public class Timetable {
	...
	public Timetable(int id, int lineNum, ArrayList<Integer> normalDep, ArrayList<Integer> weekendDep){
		this.stopID = id;
	...
	public int getFirstTimeAfter(int minutes, String whatDay){
		if(whatDay.equals("friday")){
